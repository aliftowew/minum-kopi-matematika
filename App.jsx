      ...
      <div style={{
        ...
        <div style={{ maxWidth: 620, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 11, color: "#A08E7A", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 10 }}>
              Rumus
            </p>
            <div style={{
              textAlign: "center",
              ...
              T(t) = T<sub>ruang</sub> + (T₀ − T<sub>ruang</sub>) · e<sup>−kt</sup>
            </div>
            <div style={{
              textAlign: "center",
              fontSize: 13,
              ...
              → t = −ln[(T<sub>target</sub> − T<sub>ruang</sub>) / (T₀ − T<sub>ruang</sub>)] / k
            </div>
          </div>
